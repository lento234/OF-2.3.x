...
namespace Foam
{
    defineTypeNameAndDebug(transientSimpleControl, 0);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::transientSimpleControl::read()
{
    solutionControl::read(true);
}


bool Foam::transientSimpleControl::criteriaSatisfied()
{
...
Foam::transientSimpleControl::transientSimpleControl(fvMesh& mesh)
:
...
Foam::transientSimpleControl::~transientSimpleControl()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::transientSimpleControl::loop()
{
    read();
