...
tmp<volSymmTensorField> porousrealizableKE::devReff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
tmp<fvVectorMatrix> porousrealizableKE::divDevReff(volVectorField& U) const
{
    return
    (
...
tmp<fvVectorMatrix> porousrealizableKE::divDevRhoReff
(
