...
xvertices = np.array([-50, -15, -5, 5, 15, 100])
...
custompatchIDs = [['wall', 'cube1'], ['wall', 'cube2']]
...
custompatchVertices = [ [ ( (1,1,0), (1,2,0), (1,2,1), (1,1,1) ), # left
                          ...
                          ( (1,1,1), (2,1,1), (2,2,1), (1,2,1) ), # top
                        ],
                        [ ( (3,1,0), (3,2,0), (3,2,1), (3,1,1) ), # left
                          ( (3,1,0), (4,1,0), (4,1,1), (3,1,1) ), # front
                          ( (4,1,0), (4,2,0), (4,2,1), (4,1,1) ), # right
                          ( (3,2,0), (4,2,0), (4,2,1), (3,2,1) ), # back
                          ( (3,1,1), (4,1,1), (4,2,1), (3,2,1) ), # top
                        ] ]
